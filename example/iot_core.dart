...
Future<int> main() async {
  ...
  final int port = 443; // You can also use 8883 if you so wish
  ...
  // Create the client
  final MqttClient client = new MqttClient(url, clientId);
  // Set the port
  client.port = port;
  // Set secure
  client.secure = true;
  ...
  final String currDir = path.current + path.separator + "example" +
      path.separator;
  ...
  // to the device or the JWT token is incorrect a conenct ack message will be received with a return code of
