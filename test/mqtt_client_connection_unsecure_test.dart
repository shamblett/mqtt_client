      ...
      await IOOverrides.runZoned(
        ...
        socketConnect:
            (
              ...
              int sourcePort = 0,
              Duration? timeout,
            }) => MqttMockSocketInvalidHost.connect(
              host,
              port,
      ...
      await IOOverrides.runZoned(
        ...
        socketConnect:
            (
              ...
              int sourcePort = 0,
              Duration? timeout,
            }) => MqttMockSocketInvalidPort.connect(
              host,
              port,
              sourceAddress: sourceAddress,
              sourcePort: sourcePort,
    ...
    test('Successful response and disconnect', () async {
      await IOOverrides.runZoned(
        () async {
          ...
          expect(
            status.connectAckMessage?.variableHeader.sessionPresent,
            isFalse,
          );
      ...
      await IOOverrides.runZoned(
        ...
        socketConnect:
            (
              ...
              int sourcePort = 0,
              Duration? timeout,
            }) => MqttMockSocketScenario3.connect(
              host,
              port,
              sourceAddress: sourceAddress,
              sourcePort: sourcePort,
